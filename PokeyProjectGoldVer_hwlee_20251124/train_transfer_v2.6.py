...
if __name__ == '__main__':
    ...
    # 콜백 설정
    checkpoint_callback = CheckpointCallback(save_freq=100000 // num_cpu, save_path=log_dir, name_prefix=f'poke_smart_{sess_id}')
    tensorboard_callback = TensorboardCallback(log_dir=log_dir)
    unfreeze_callback = UnfreezeCallback(unfreeze_step=500_000) # 수정
