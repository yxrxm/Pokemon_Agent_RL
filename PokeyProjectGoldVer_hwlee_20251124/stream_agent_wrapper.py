...
#$DA02 to $DA03 = X-Y coordinates of character on overworld
#맞는지 체크하는 건 나중에 가서

X_POS_ADDRESS, Y_POS_ADDRESS = 0xDA02, 0xDA03
MAP_N_ADDRESS = 0xDA01 #current Map number
...
class StreamWrapper(gym.Wrapper):
    ...
    def step(self, action):
        ...
        #수정사항 1
        # self.env는 GoldEnv 객체이므로, GoldEnv의 함수를 호출합니다.
